...
function regLinkClickHandlers() {
    ...
    $j('#link_fetch_sfdc_contacts').click(function() {
                                         ...
                                         forcetkClient.query("SELECT Name FROM Contact Limit 5", onSuccessSfdcContacts, onErrorSfdc); 
                                         });
    
    $j('#link_fetch_sfdc_accounts').click(function() {
                                         logToConsole("link_fetch_sfdc_accounts clicked");
                                         forcetkClient.query("SELECT Name FROM Account Limit 5", onSuccessSfdcAccounts, onErrorSfdc); 
                                         });
